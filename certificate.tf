...
resource "tls_cert_request" "cloud_controller_manager" {
  key_algorithm          = tls_private_key.cloud_controller_manager.algorithm
  private_key_pem        = tls_private_key.cloud_controller_manager.private_key_pem
...
resource "tls_locally_signed_cert" "cloud_controller_manager" {
  cert_request_pem       = tls_cert_request.cloud_controller_manager.cert_request_pem
  ca_key_algorithm       = tls_private_key.kube_ca.algorithm
  ca_private_key_pem     = tls_private_key.kube_ca.private_key_pem
  ca_cert_pem            = tls_self_signed_cert.kube_ca.cert_pem
...
resource "local_file" "cloud_controller_manager_key" {
  content                = tls_private_key.cloud_controller_manager.private_key_pem
  filename               = "./certificate/cloud-controller-manager-key.pem"
}

resource "local_file" "cloud_controller_manager_crt" {
  content                = tls_locally_signed_cert.cloud_controller_manager.cert_pem
  filename               = "./certificate/cloud-controller-manager.pem"
}
